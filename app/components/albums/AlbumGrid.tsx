                            ...
                            <div className={`p-8 md:w-2/5 flex flex-col justify-end relative min-h-[300px] ${selectedAlbum.coverColor} overflow-hidden`}>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button className="flex-1 bg-white text-black font-bold py-3 px-6 rounded-full flex items-center justify-center gap-2 hover:scale-105 transition-transform">
